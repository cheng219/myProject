...
namespace fsm
{
    ...
    public class State
    {
        ...
        /// <summary>
        /// 启动状态，只在状态机类型为State.Exclusive的情况下才生效 by邓成
        /// </summary>
        ...
        /// <summary>
        /// 状态切换时的事件，仅当本身为一个状态机时 by邓成
        /// </summary>
        public OnEventHandler onEvent;
        /// <summary>
        /// 在状态机Update()时候调用的更新事件 by邓成
        /// </summary>
        ...
        /// <summary>
        /// 进入某一个状态（机），并根据该状态（机）的模式进行相应的处理 by邓成
        /// </summary>
        /// <param name="_event"></param>
